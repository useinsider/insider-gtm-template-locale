...

{
  ...
  "version": 1,
  "securityGroups": [],
  "displayName": "Insider Page Locale",
  ...
  "description": "This template get locale information.",
  "containerContexts": [
    "WEB"
  ]
}
...
[
  {
    "type": "TEXT",
    "name": "locale",
    "displayName": "Locale Variable Name",
...
insiderObject.user.locale = getData(data.locale);
...
Created on 11/20/2020, 3:02:10 PM
